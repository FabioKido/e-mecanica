...
export default function ({ options, total_value, handleSaveExpense, loading }) {
  ...
  function setInfosParcel() {
    ...
    handleSaveExpense(row_parcel, 1);
  ...
  if (options === 'Parcelada') {
    return (
      <>
        ...
        <SubmitButton onPress={() => handleSaveExpense(rows_parcels, parcels)}>
          {loading ? (
